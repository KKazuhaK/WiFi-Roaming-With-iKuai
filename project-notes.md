...
| 成员 UPN 格式 | `user@kazuha.org` (Primary domain) |
| 租户内其他 custom domain | `kazuhahub.com` (非 Primary，用于 Portal) |
...
| 字段 | 值 |
|---|---|
| Tenant ID | `e72914d3-3d19-486e-be11-15c69540e02a` |
| Client ID | `199d45bd-7c7b-4eed-983e-758c8aa12d18` |
| App Registration 名称 | `Kazuha Hub WiFi Portal` |
| Redirect URI | `https://wifi.login.kazuhahub.com/auth/callback` |
