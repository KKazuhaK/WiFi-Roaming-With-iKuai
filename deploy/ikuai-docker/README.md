...
设备 (连 Kazuha Hub WiFi)
    │
    │  1. 访问任何 HTTPS → iKuai 捕获 302 到 https://wifi.login.kazuhahub.com:28081/portal
    │  2. iKuai DNS 劫持: wifi.login.kazuhahub.com → iKuai 自己的 LAN IP (例如 192.168.1.1)
...
```
{"level":"info","msg":"trying to solve challenge","identifier":"wifi.login.kazuhahub.com","challenge_type":"dns-01"}
...
`https://wifi.login.kazuhahub.com:28081/auth/callback` 应该已经在了。没在就加上。
