...
| `PORTAL_HOSTNAME` | `wifi.login.kazuhahub.com` (一般不变) | 同一个 |
| `PORTAL_HTTPS_PORT` | 默认 `28081` | 同一个 |
| `PUBLIC_URL` | `https://wifi.login.kazuhahub.com:28081` (端口对上) | 同一个 |
...
curl -v --resolve wifi.login.kazuhahub.com:28081:<LAN_IP_OF_BOX> \
  https://wifi.login.kazuhahub.com:28081/healthz
# 预期: 证书有效 + 响应 "ok"
```
